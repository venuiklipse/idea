...
public class IpChallehgeCatDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory.getLogger(IpChallehgeCatDAO.class);
	// property constants
	...
	public static IpChallehgeCatDAO getFromApplicationContext(ApplicationContext ctx) {
		return (IpChallehgeCatDAO) ctx.getBean("IpChallehgeCatDAO");
	}
}